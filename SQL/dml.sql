...
INSERT INTO controlSiembra (siembra_id, fecha, observaciones) VALUES
(1, '2023-10-01', 'Buen estado general'),
(2, '2023-10-02', 'Hojas ligeramente secas');
...
INSERT INTO faseProduccion (produccion_id, nombre_fase, descripcion) VALUES
(1, 'Fermentación', 'Fase de fermentación'),
(1, 'Clarificación', 'Fase de Clarificación'),
(2, 'Fermentación', 'Fase de Fermentación');
...
INSERT INTO cata (fecha, calificacion, observaciones, idEvaluador, idProduccion) VALUES
('2023-06-20 15:30:00', 9, 'Notas florales, buena acidez, excelente cuerpo', 1, 1);
