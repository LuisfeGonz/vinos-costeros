...
namespace SistemaVC_VinosCosteros.Controllers
{
    public class rolsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,nombre,descripcion,estatus")] rol rol)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,nombre,descripcion,estatus")] rol rol)
        {
            if (ModelState.IsValid)
            {
